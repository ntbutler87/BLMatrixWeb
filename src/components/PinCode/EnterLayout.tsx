...
const EnterLayout = ({ pin, styles, mode, textOptions, options, onSwitchMode, onEnter, onReset, onMaxAttempt, onCancel }: {
    ...
    return <>
        ...
        <View style={[DEFAULT.Styles.enter?.content, styles?.content]}>
            ...
            <NumbersPanel disabled={disabled} onButtonPress={onNumberPress}
                ...
                textStyle={styles?.buttonText} disabledStyle={styles?.buttonTextDisabled} allowCancel={options?.allowCancel} 
                cancelStyle={styles?.cancelText} backspaceStyle={styles?.backspaceText}
            />
        </View>
