...
export namespace PinCodeT {
    ...
    export type EnterStyles = EnterSetStyles & {
        ...
        /**
         * Style of the Cancel text
         */
        cancelText?: StyleProp<TextStyle>;
        /**
         * Style of the Backspace/Delete text
         */
        backspaceText?: StyleProp<TextStyle>;
    };
    ...
    export interface PinCodeProps {
        ...
        /**
         * Triggered when the user cancels entering a pin
         * @returns 
         */
        onCancel?: () => void;
        /**
    ...
    export interface Options {
        ...
        disableLock?: boolean;
        /**
         * If allowCancel is set to true, the "Cancel" button is displayed on the NumbersPanel screen
         */
        allowCancel?: boolean;
        /**
